...
(async () => {
  ...
  try{
    ...
    const result1 = await page2.evaluate(()=>{
      let heading = document.querySelector("#taskInput");
      return heading.innerHTML;
    })
  ...
  try{
    ...
    const result1 = await page3.evaluate(()=>{
      let heading = document.querySelector("#addButton");
      return heading.innerHTML;
    })
  ...
  try{
    ...
    await page4.waitForSelector('div');
    const result1 = await page4.evaluate(()=>{
      let heading = document.querySelector("#taskList");
      return heading.innerHTML;
    })
